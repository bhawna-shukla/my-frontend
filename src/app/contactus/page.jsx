                    ...
                    <div className="lg:flex lg:items-center lg:-mx-10">
                        <div className="lg:w-1/2 lg:mx-10">
                            ...
                            <form className="mt-12">
                                ...
                                <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-2xl hover:bg-red-900 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                    Send your message
                                </button>
                            </form>
                        </div>
                        <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                            ...
                            <div className="mt-6 space-y-8 md:mt-8">
                                ...
                                <p className="flex items-start -mx-2">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="w-6 h-6 mx-2 text-blue-500 dark:text-blue-900"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                        strokeWidth={2}
                                    ...
                                    <span className="mx-2  text-blue-700 truncate w-72 dark:text-blue-900" >
                                        acb@example.com
                                    </span>
                                </p>
                            </div>
                            <div className="mt-6 w-80 md:mt-8">
                                ...
                                <div className="flex mt-4 -mx-1.5 ">
                                    ...
                                    <a
                                        className="mx-1.5 dark:hover:text-white-900 text-white-400 transition-colors duration-300 transform hover:text-blue-500"
                                        href="#"
                                    >
                                        <svg
                                            className="w-8 h-8"
                                    ...
                                    <a
                                        className="mx-1.5 dark:hover:text-white-400 text-white-400 transition-colors duration-300 transform hover:text-blue-900"
                                        href="#"
                                    >
                                        <svg
                                            className="w-8 h-8"
